-- Rollback 025B4 — restore ONLY the 24 active manifest price_from values to NULL.
...
INSERT INTO pr_j2b4_b4_values (id, price_from) VALUES
  ('37f6a3ae-f758-4449-83f5-e036c83f189d'::uuid, 217),
  ('3468ea14-5f5e-40f6-9234-0fedf137189e'::uuid, 192),
  ('8f3cdc36-f243-45da-b3b5-ecfba83929a6'::uuid, 1269),
  ('d5e5c0e9-6549-497a-97a3-4843621da5dc'::uuid, 217),
  ('4d3bbbb8-3907-459b-af10-181ace7af8ec'::uuid, 1938),
  ('12da1d30-0d8d-49df-b350-fe6880c56ab8'::uuid, 1000),
  ('535ac95b-f891-4e1c-916f-57028d7cb9e0'::uuid, 1324),
  ('d48f2466-e466-4801-886c-cd28c6cc97c6'::uuid, 203),
  ('9b0aefcc-3604-4d5c-bcc2-0b8ee80bb621'::uuid, 7914),
  ('eb9647df-6b38-46be-9920-9b80f27a9d2e'::uuid, 5648),
  ('4a22ea8c-15a2-4b39-b1d2-c7b3d3e32fd7'::uuid, 1000),
  ('d2be5f8a-75a3-453a-88e6-a13c8baa70d4'::uuid, 1709),
  ('fe99d869-cb67-4ba7-8791-ecdfa38c2701'::uuid, 1367),
  ('aa64bf32-d48f-4d5a-8bb7-e0e85353de5c'::uuid, 1593),
  ('062f363b-eabb-493c-a15b-fe769db12ac5'::uuid, 786),
  ('28ae5874-2c8f-4f88-895e-09cb45c36872'::uuid, 456),
  ('43afa024-0a6b-42a4-ab24-b582778ad587'::uuid, 2828),
  ('645c7b01-6a18-4246-91b7-69f1311e9ebc'::uuid, 1873),
  ('743d03b7-82a9-4d72-9715-10ee9df9f231'::uuid, 540),
  ('bfd44a68-c631-4e23-950f-f93a7e9231b5'::uuid, 1231),
  ('06f935af-8ca1-45e0-bdc3-053b94907cf2'::uuid, 186),
  ('1211dc54-4653-4bb1-a925-75fa38477919'::uuid, 3137),
  ('ef87b1c3-d52a-4e8e-ade7-950e1bceadb3'::uuid, 2866),
  ('08579f34-894b-4278-9608-a96f54d2b591'::uuid, 1827);
