      ...
      <Section background="white" padding="lg">
        <Container size="xl">
          <div className="flex items-center gap-4 mb-6">
            ...
            <Heading level={1} className="text-3xl font-bold">添加 Extension</Heading>
          </div>
          ...
          <form onSubmit={handleSubmit}>
            <Card className="p-6 space-y-6">
              ...
              {/* 图片上传 */}
              <div>
                <Heading level={2} className="text-xl font-semibold mb-4">图片</Heading>
                <div className="space-y-4">
                  <div>
              ...
              {/* 坐标信息 */}
              <div>
                <Heading level={2} className="text-xl font-semibold mb-4">地图坐标（可选）</Heading>
