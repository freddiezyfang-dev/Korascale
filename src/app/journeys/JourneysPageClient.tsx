...
export default function JourneysPageClient({ initialJourneys }: JourneysPageClientProps) {
	const { journeys: contextJourneys, isLoading } = useJourneyManagement();

	const journeys =
		initialJourneys && initialJourneys.length > 0
			? initialJourneys
			: contextJourneys.length > 0
				? contextJourneys
				: defaultJourneys;
					...
					<div className="flex flex-col md:flex-row gap-8">
						...
						<div className="flex-1 min-w-0">
							...
							<div className="flex items-center justify-between gap-4 mb-6 md:mb-8">
								<h1 className="text-2xl sm:text-3xl font-serif flex-1 min-w-0" style={{ fontFamily: 'var(--font-playfair), Playfair Display, serif' }}>
