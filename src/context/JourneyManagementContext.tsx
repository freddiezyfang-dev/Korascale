...
import { journeyAPI, JourneyPublishIntegrityClientError, JourneySlugConflictClientError } from '@/lib/databaseClient';
...
const defaultJourneys: Journey[] = [
  ...
  },
  {
    ...
    overview: {
      breadcrumb: ['Home','Journey','Culture','Leshan Giant Buddha'],
  ...
  },
  {
    ...
    overview: {
      breadcrumb: ['Home','Journey','Culture','Dujiangyan Irrigation'],
  ...
  },
  {
    ...
    overview: {
      breadcrumb: ['Home','Journey','Nature','Jiuzhaigou & Huanglong'],
