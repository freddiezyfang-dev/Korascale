export const JOURNEY_REVISION_ERROR_CODES = {
	...
	NO_CHANGES: 'JOURNEY_REVISION_NO_CHANGES',
	POST_WRITE_INTEGRITY_FAILED: 'JOURNEY_REVISION_POST_WRITE_INTEGRITY_FAILED',
	PROPOSED_SNAPSHOT_INTEGRITY_FAILED:
		'JOURNEY_REVISION_PROPOSED_SNAPSHOT_INTEGRITY_FAILED',
} as const;
