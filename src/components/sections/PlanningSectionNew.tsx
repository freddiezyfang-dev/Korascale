...
import { CUSTOMER_SERVICE_EMAIL, CUSTOMER_SERVICE_MAILTO } from '@/lib/contactChannels';
import type { InquirySourceType } from '@/lib/inquiries/types';

const imgLogo = '/logo.png';

type PlanningSectionNewProps = {
  sourceType?: InquirySourceType;
};

export default function PlanningSectionNew({ sourceType = 'direct' }: PlanningSectionNewProps) {
